"""
Two-phase MCTS Hex player (apples-to-apples with L*).
...
on out-of-tree states. ZERO oracle calls during eval.

Usage:
    python -m src.scripts.mcts_trained_player_hex --size 3 --train-K 5000
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description='Two-phase trained MCTS Hex player.'
    )
    ...
    print(f'Trained-MCTS Hex  size={args.size}  train_K={args.train_K}  c={args.c}  '
