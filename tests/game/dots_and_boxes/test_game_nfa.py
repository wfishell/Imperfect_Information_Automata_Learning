...
class TestExtraTurnMechanic:
    def test_same_player_after_box_completion(self, nfa):
        # box(0,0): edges 0,2,6,7
    ...
    def test_after_double_completion(self, nfa):
...
class TestLegalInputs:
    ...
    def test_p1_legal_inputs_pass_on_p2_turn(self, nfa):
    ...
    def test_p2_legal_moves_available_after_box_completion(self, nfa):
...
class TestTerminalAndCurrentPlayer:
    ...
    def test_current_player_same_after_box_completion(self, nfa):
